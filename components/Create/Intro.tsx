    ...
    return (
        <>
            <div className="flex lg:flex-row flex-col lg:text-start text-center items-center justify-center gap-4 py-24 sm:px-12 ssm:px-8">
                <div className={`border-[1px] flex flex-col gap-1 ${borderColor} px-12 py-4 text-sm`}>
                ...
                <div className="border-[1px] border-gray-300 flex flex-col gap-1 px-12 py-4 text-sm">
